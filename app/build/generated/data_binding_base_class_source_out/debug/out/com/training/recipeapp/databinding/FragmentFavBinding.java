...
public final class FragmentFavBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvFavouritMeals;

  private FragmentFavBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView rvFavouritMeals) {
    this.rootView = rootView;
    this.rvFavouritMeals = rvFavouritMeals;
  }
  ...
  public static FragmentFavBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rv_Favourit_meals;
      RecyclerView rvFavouritMeals = ViewBindings.findChildViewById(rootView, id);
      if (rvFavouritMeals == null) {
        break missingId;
      }

      return new FragmentFavBinding((LinearLayout) rootView, rvFavouritMeals);
    }
