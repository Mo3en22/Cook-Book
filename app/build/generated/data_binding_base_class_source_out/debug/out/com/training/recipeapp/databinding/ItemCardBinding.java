...
public final class ItemCardBinding implements ViewBinding {
  ...
  private ItemCardBinding(@NonNull CardView rootView, @NonNull ImageView ivProduct,
      @NonNull CardView myCard, @NonNull TextView tvProduct) {
  ...
  public static ItemCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CardView myCard = (CardView) rootView;
      ...
      return new ItemCardBinding((CardView) rootView, ivProduct, myCard, tvProduct);
    }
